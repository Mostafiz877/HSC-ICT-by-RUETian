      ...
      children: <Widget>[
        WebView(
          ...
          initialUrl: Uri.dataFromString(
                  '<html><head><style>body{margin:0;padding:0;}.responsive-youtube{overflow:hidden; padding-bottom:56.25%; position:relative; height:0;}.responsive-youtube iframe{left:0; top:0; height:100%; width:100%; position:absolute;}</style></head><body bgcolor="#18191A"><div class="responsive-youtube">$videoLink</div></body></html>',
                  mimeType: 'text/html')
              .toString(),
